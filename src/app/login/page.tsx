    ...
    <div className="w-full min-h-screen flex flex-col items-center justify-center p-6">
      ...
      <div className="w-full max-w-md mx-auto z-10">
         <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-bold font-headline glitch" data-text="Welcome Back">
              Welcome Back
            </h1>
            <p className="text-text-secondary mt-2">Sign in to continue to ClaimFlow</p>
        </div>
        ...
        <Card className="bg-glass-dark border-glass-border backdrop-blur-lg shadow-glass-glow">
          ...
          <CardContent>
            <form onSubmit={handleLogin} className="space-y-8 pt-4">
              ...
              <div className="relative">
                 <div className="flex items-center justify-between absolute top-[-1.5rem] w-full">
                    <div></div>
                    <Link href="#" className="text-sm text-electric-cyan hover:underline">
                        Forgot password?
                    </Link>
                </div>
        ...
        <p className="mt-6 text-center text-sm text-text-secondary">
          ...
          <Link href="/signup" className="font-semibold text-electric-cyan hover:underline">
            Sign Up
          </Link>
        </p>
      </div>
